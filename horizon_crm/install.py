...
def set_branding():
	"""Set white label branding to Horizon CRM."""
	# Website Settings
	ws = frappe.get_single("Website Settings")
	ws.app_name = "Horizon CRM"
	ws.footer_powered = "Powered by Horizon CRM"
	ws.copyright = "Horizon CRM"
	ws.favicon = "/assets/horizon_crm/images/favicon.svg"
