...
| Aspect | Frappe CRM | Horizon CRM |
|--------|-----------|-------------|
| **App Name** | "Frappe CRM" | "Horizon CRM" |
| **Logo** | Frappe logo | Custom SVG logo |
| **Footer** | "Built with Frappe" | "Powered by Horizon CRM" |
| **Copyright** | Frappe Technologies | Horizon CRM |

**Status**: ✅ Complete white-labeling: all user-visible "Frappe" references replaced with "Horizon CRM" (hooks.py, JS, CSS comments, database settings, install script).
...
*Plan maintained by Horizon CRM Development Team*
